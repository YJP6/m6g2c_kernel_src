...
#else
static inline void osl_pcmcia_read_attr(osl_t *osh, uint offset, void *buf, int size){}
static inline void osl_pcmcia_write_attr(osl_t *osh, uint offset, void *buf, int size){}
#endif
...
#else
static inline uint32 osl_pci_read_config(osl_t *osh, uint offset, uint size){return 0;}
static inline void osl_pci_write_config(osl_t *osh, uint offset, uint size, uint val){}
#endif
